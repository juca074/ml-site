...
$OFFER_HASH        = 'm3zjpyur9j_kjxlgxscl3';
$PRODUCT_HASH      = 'm3zjpyur9j';
$BASE_AMOUNT       = 6770;
$PRODUCT_TITLE     = 'JBL boombox 3';
...
function render_checkout_component($component_id, $all_components_map) {
    ...
    $checkout_settings = [
        ...
        'productLogoURL' => 'https://roletadepromoblackfriday.com/Produtos/jbl01/images/poco_preto.png',
        'title' => 'JBL boombox 3',
        'amountFormatted' => 'R$ ' . number_format(6770 / 100, 2, ',', '.'),
...
<head>
    ...
    <title><?php echo htmlspecialchars('JBL boombox 3'); ?></title>
