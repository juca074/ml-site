...
$OFFER_HASH        = 'ZoAXpwXg';
$PRODUCT_HASH      = 'b8umdb8e94';
$BASE_AMOUNT       = 8700;
$PRODUCT_TITLE     = 'XIAOMI POCO x5 5G Global Dual SIM 256 GB Blue 8GB RAM';
...
function render_checkout_component($component_id, $all_components_map) {
    ...
    $checkout_settings = [
        ...
        'productLogoURL' => 'https://i.postimg.cc/8cmQVnwv/x1.jpg',
        'title' => 'XIAOMI POCO x5 5G Global Dual SIM 256 GB Blue 8GB RAM',
        'amountFormatted' => 'R$ ' . number_format(8700 / 100, 2, ',', '.'),
...
<head>
    ...
    <title><?php echo htmlspecialchars('XIAOMI POCO x5 5G Global Dual SIM 256 GB Blue 8GB RAM'); ?></title>
