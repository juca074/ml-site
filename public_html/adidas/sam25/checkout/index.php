...
$OFFER_HASH        = 'GW1WpD63';
$PRODUCT_HASH      = 'eitjdppnsk';
$BASE_AMOUNT       = 24790;
$PRODUCT_TITLE     = 'Samsung Galaxy S25 Ultra 5G, 512GB, 12GB, Câmera Quádrupla Titânio Preto';
...
function render_checkout_component($component_id, $all_components_map) {
    ...
    $checkout_settings = [
        ...
        'productLogoURL' => 'https://i.postimg.cc/Tw1CP5tP/s1.jpg',
        'title' => 'Samsung Galaxy S25 Ultra 5G, 512GB, 12GB, Câmera Quádrupla Titânio Preto',
        'amountFormatted' => 'R$ ' . number_format(24790 / 100, 2, ',', '.'),
...
<head>
    ...
    <title><?php echo htmlspecialchars('Samsung Galaxy S25 Ultra 5G, 512GB, 12GB, Câmera Quádrupla Titânio Preto'); ?></title>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    let totalAmount = 24790;
    let baseAmount = 24790;
