...
$OFFER_HASH        = 'ZD7jrM83';
$PRODUCT_HASH      = '61eunnsvja';
$BASE_AMOUNT       = 25700;
$PRODUCT_TITLE     = 'iPhone 16 Pro Max 1 TB Titânio-Preto';
...
function render_checkout_component($component_id, $all_components_map) {
    ...
    $checkout_settings = [
        ...
        'productLogoURL' => 'https://i.postimg.cc/nh1rDjyy/iphon1.jpg',
        'title' => 'iPhone 16 Pro Max 1 TB Titânio-Preto',
        'amountFormatted' => 'R$ ' . number_format(25700 / 100, 2, ',', '.'),
...
<head>
    ...
    <title><?php echo htmlspecialchars('iPhone 16 Pro Max 1 TB Titânio-Preto'); ?></title>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    let totalAmount = 25700;
    let baseAmount = 25700;
