...
$OFFER_HASH        = 'Z8a2JYzG';
$PRODUCT_HASH      = 'ppeulv19lq';
$BASE_AMOUNT       = 7947;
$PRODUCT_TITLE     = 'Sofá Retrátil Reclinável King House Verona 2.00m Velut Cinza C Molas';
...
function render_checkout_component($component_id, $all_components_map) {
    ...
    $checkout_settings = [
        ...
        'productLogoURL' => 'https://i.postimg.cc/q7y4JDw6/s1.jpg',
        'title' => 'Sofá Retrátil Reclinável King House Verona 2.00m Velut Cinza C Molas',
        'amountFormatted' => 'R$ ' . number_format(7947 / 100, 2, ',', '.'),
...
<head>
    ...
    <title><?php echo htmlspecialchars('Sofá Retrátil Reclinável King House Verona 2.00m Velut Cinza C Molas'); ?></title>
