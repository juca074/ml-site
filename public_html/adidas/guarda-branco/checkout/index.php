...
$OFFER_HASH        = 'GV0Ly2o3';
$PRODUCT_HASH      = 'oylroudwjg';
$BASE_AMOUNT       = 11460;
$PRODUCT_TITLE     = 'Guardaroupa Casal Easy Slim 8 Pts C Esp E Pés Amendoa/off';
...
function render_checkout_component($component_id, $all_components_map) {
    ...
    $checkout_settings = [
        ...
        'productLogoURL' => 'https://i.postimg.cc/mDwn4X42/g1.jpg',
        'title' => 'Guardaroupa Casal Easy Slim 8 Pts C Esp E Pés Amendoa/off',
        'amountFormatted' => 'R$ ' . number_format(11460 / 100, 2, ',', '.'),
...
<head>
    ...
    <title><?php echo htmlspecialchars('Guardaroupa Casal Easy Slim 8 Pts C Esp E Pés Amendoa/off'); ?></title>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    let totalAmount = 11460;
    let baseAmount = 11460;
