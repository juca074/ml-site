...
function render_checkout_component($component_id, $all_components_map) {
    ...
    $checkout_settings = [
        ...
        'productLogoURL' => 'https://regasteoseupremio.com/rl-loja/images/poco_preto.png',
        'title' => 'JBL boombox 3',
        'amountFormatted' => 'R$ ' . number_format(6779 / 100, 2, ',', '.'),
