...
$OFFER_HASH        = '3EERy6w3';
$PRODUCT_HASH      = '5iprubtee7';
$BASE_AMOUNT       = 9999;
$PRODUCT_TITLE     = 'Fogão 5 Bocas Atlas Com Mesa De Vidro 127V220V';
...
function render_checkout_component($component_id, $all_components_map) {
    ...
    $checkout_settings = [
        ...
        'productLogoURL' => 'https://i.postimg.cc/bYCZFhwk/f1.jpg',
        'title' => 'Fogão 5 Bocas Atlas Com Mesa De Vidro 127V220V',
        'amountFormatted' => 'R$ ' . number_format(9999 / 100, 2, ',', '.'),
...
<head>
    ...
    <title><?php echo htmlspecialchars('Fogão 5 Bocas Atlas Com Mesa De Vidro 127V220V'); ?></title>
