...
$OFFER_HASH        = 'ZvKXYMwG';
$PRODUCT_HASH      = 'rclpq5uj0e';
$BASE_AMOUNT       = 12700;
$PRODUCT_TITLE     = 'Smart TV 55 polegadas Led Android Com Wifi Dolby Philco';
...
function render_checkout_component($component_id, $all_components_map) {
    ...
    $checkout_settings = [
        ...
        'productLogoURL' => 'https://i.postimg.cc/66GcHmpj/tv1.jpg',
        'title' => 'Smart TV 55 polegadas Led Android Com Wifi Dolby Philco',
        'amountFormatted' => 'R$ ' . number_format(12700 / 100, 2, ',', '.'),
...
<head>
    ...
    <title><?php echo htmlspecialchars('Smart TV 55 polegadas Led Android Com Wifi Dolby Philco'); ?></title>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    let totalAmount = 12700;
    let baseAmount = 12700;
