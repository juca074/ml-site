...
$OFFER_HASH        = 'ZxxEDRrZ';
$PRODUCT_HASH      = 'cgiefdiwea';
$BASE_AMOUNT       = 9737;
$PRODUCT_TITLE     = 'Xiaomi Poco X6 Pro 8gb Ram 256gb + Cor Preto';
...
function render_checkout_component($component_id, $all_components_map) {
    ...
    $checkout_settings = [
        ...
        'productLogoURL' => 'https://i.postimg.cc/cCfK5ypq/x1.jpg',
        'title' => 'Xiaomi Poco X6 Pro 8gb Ram 256gb + Cor Preto',
        'amountFormatted' => 'R$ ' . number_format(9737 / 100, 2, ',', '.'),
...
<head>
    ...
    <title><?php echo htmlspecialchars('Xiaomi Poco X6 Pro 8gb Ram 256gb + Cor Preto'); ?></title>
