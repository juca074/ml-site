...
$OFFER_HASH        = 'GYAkjBKG';
$PRODUCT_HASH      = 'qxhh1n2naz';
$BASE_AMOUNT       = 10700;
$PRODUCT_TITLE     = 'Guarda Roupa Casal 8 Portas Natasha Preto M Arapongas Cor Preto Fosco';
...
function render_checkout_component($component_id, $all_components_map) {
    ...
    $checkout_settings = [
        ...
        'productLogoURL' => 'https://i.postimg.cc/MGmFy6Tp/g1.jpg',
        'title' => 'Guarda Roupa Casal 8 Portas Natasha Preto M Arapongas Cor Preto Fosco',
        'amountFormatted' => 'R$ ' . number_format(10700 / 100, 2, ',', '.'),
...
<head>
    ...
    <title><?php echo htmlspecialchars('Guarda Roupa Casal 8 Portas Natasha Preto M Arapongas Cor Preto Fosco'); ?></title>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    let totalAmount = 10700;
    let baseAmount = 10700;
